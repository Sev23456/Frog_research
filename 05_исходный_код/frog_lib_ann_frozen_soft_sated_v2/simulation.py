...
class ANNFlyCatchingSimulation:
    def __init__(
        ...
        if not headless:
            ...
            pygame.display.set_caption("ANN Frozen Frog - soft homeostatic V2 predator")
    ...
    def _draw_hud(self):
        ...
        title = self.title_font.render("ANN Frozen Soft-Homeostatic V2", True, YELLOW)
    ...
    def run_simulation(self, max_steps: int = 2000):
        print(f"ANN frozen homeostatic simulation start: steps={max_steps}, headless={self.headless}, training={self.training_mode}")
        ...
        print(
            "ANN frozen homeostatic summary | catches={caught_flies} success={success_rate:.3f} "
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "architecture_signature": "frozen actor-critic visual predator with satiety-gated strike loop",
        }

    def save_state(self, filename: str = "ann_frozen_homeostatic_frog_state.json"):
