...
if __package__ in (None, ""):
    ...
    from frog_lib_ann_frozen_soft_sated_v2.simulation import ANNFlyCatchingSimulation
else:
    from .simulation import ANNFlyCatchingSimulation


def main():
    parser = argparse.ArgumentParser(description="Run standalone frozen soft-satiation V2 ANN frog simulation")
