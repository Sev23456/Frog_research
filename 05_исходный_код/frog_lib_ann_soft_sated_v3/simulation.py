...
class ANNFlyCatchingSimulation:
    def __init__(
        ...
        if not headless:
            ...
            pygame.display.set_caption("ANN Frog - soft homeostatic V3 actor-critic predator")
    ...
    def _draw_hud(self):
        ...
        title = self.title_font.render("ANN Soft-Homeostatic V3", True, YELLOW)
    ...
    def run_simulation(self, max_steps: int = 2000):
        print(f"ANN homeostatic V3 simulation start: steps={max_steps}, headless={self.headless}, training={self.training_mode}")
        ...
        print(
            "ANN homeostatic V3 summary | catches={caught_flies} success={success_rate:.3f} "
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "architecture_signature": "actor-critic visual predator with upstream homeostatic prey-selection gate",
        }

    def save_state(self, filename: str = "ann_homeostatic_v3_frog_state.json"):
