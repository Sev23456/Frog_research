...
from frog_lib_ann_soft_sated_v2.simulation import ANNFlyCatchingSimulation as ANNSoftSatedV2Simulation
from frog_lib_ann_frozen_soft_sated_v2.simulation import ANNFlyCatchingSimulation as ANNFrozenSoftSatedV2Simulation
from frog_lib_ann_soft_sated_v3.simulation import ANNFlyCatchingSimulation as ANNSoftSatedV3Simulation
from frog_lib_ann_frozen_soft_sated_v3.simulation import ANNFlyCatchingSimulation as ANNFrozenSoftSatedV3Simulation
from frog_lib_ann_soft_sated_v3_1.simulation import ANNFlyCatchingSimulation as ANNSoftSatedV31Simulation
from frog_lib_ann_frozen_soft_sated_v3_1.simulation import ANNFlyCatchingSimulation as ANNFrozenSoftSatedV31Simulation
...
def instantiate_simulation(arch: str, training_mode: bool, model_seed: int):
    ...
    if arch == "ANN_SOFT_SATED_V2":
        return ANNSoftSatedV2Simulation(headless=True, training_mode=training_mode)
    if arch == "ANN_FROZEN_SOFT_SATED_V2":
        return ANNFrozenSoftSatedV2Simulation(headless=True, training_mode=training_mode)
    if arch == "ANN_SOFT_SATED_V3":
        return ANNSoftSatedV3Simulation(headless=True, training_mode=training_mode)
    if arch == "ANN_FROZEN_SOFT_SATED_V3":
        return ANNFrozenSoftSatedV3Simulation(headless=True, training_mode=training_mode)
    if arch == "ANN_SOFT_SATED_V3_1":
        return ANNSoftSatedV31Simulation(headless=True, training_mode=training_mode)
    if arch == "ANN_FROZEN_SOFT_SATED_V3_1":
        return ANNFrozenSoftSatedV31Simulation(headless=True, training_mode=training_mode)
    if arch == "SNN":
