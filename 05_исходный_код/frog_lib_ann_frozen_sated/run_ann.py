...
if __package__ in (None, ""):
    ...
    from frog_lib_ann_frozen_sated.simulation import ANNFlyCatchingSimulation
else:
    from .simulation import ANNFlyCatchingSimulation


def main():
    parser = argparse.ArgumentParser(description="Run standalone frozen satiation-aware ANN frog simulation")
