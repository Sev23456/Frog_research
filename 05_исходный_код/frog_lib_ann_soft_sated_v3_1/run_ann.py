...
if __package__ in (None, ""):
    ...
    from frog_lib_ann_soft_sated_v3_1.simulation import ANNFlyCatchingSimulation
else:
    from .simulation import ANNFlyCatchingSimulation


def main():
    parser = argparse.ArgumentParser(description="Run standalone soft-satiation V3.1 ANN frog simulation")
