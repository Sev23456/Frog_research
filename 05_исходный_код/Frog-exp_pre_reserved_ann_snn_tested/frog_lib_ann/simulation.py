...
class ANNFlyCatchingSimulation:
    def __init__(
        ...
        if not headless:
            ...
            pygame.display.set_caption("ANN Frog - actor-critic predator")
    ...
    def _draw_hud(self):
        ...
        title = self.title_font.render("ANN Neuro Panel", True, YELLOW)
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "architecture_signature": "actor-critic visual predator",
        }
