...
if __package__ in (None, ""):
    ...
    from .simulation import SNNFlyCatchingSimulation


def main():
    parser = argparse.ArgumentParser(description="Run standalone SNN frog simulation")
    parser.add_argument("--headless", action="store_true", help="Run without visualization")
    parser.add_argument("--width", type=int, default=800)
    parser.add_argument("--height", type=int, default=600)
    parser.add_argument("--num-flies", type=int, default=15)
    parser.add_argument("--steps", type=int, default=2000)
    parser.add_argument("--training", action="store_true", help="Enable reward-modulated learning")
