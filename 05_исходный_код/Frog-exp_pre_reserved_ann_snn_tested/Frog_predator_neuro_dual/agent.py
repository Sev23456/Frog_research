...
from Frog_predator_neuro_dual.utils import clamp, format_tile, in_bounds, pixel_distance, pixel_to_tile, tile_center
...
class BioFrogAgent:
    ...
    def apply_motion(self, world, velocity, perception, dt):
        ...
        for wall_x, wall_y, weight in wall_vectors:
            ...
            # Track diagonal corner pressure (when both components в‰  0)
