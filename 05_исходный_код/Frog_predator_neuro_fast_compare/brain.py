...
from Frog_predator_neuro_fast.architecture import BasalGanglia, MotorHierarchy, RetinalProcessing, SpatialMemory, Tectum
...
from Frog_predator_neuro_fast.core import NeurotransmitterDiffusion
from Frog_predator_neuro_fast.metabolism.systemic_metabolism import NeuronMetabolism, SystemicMetabolism
from Frog_predator_neuro_fast.plasticity.functional_plasticity import FunctionalPlasticityManager, StructuralPlasticityManager
from Frog_predator_neuro_fast.utils import add_vectors, clamp, normalize_vector, scale_vector
...
class BioFrogBrain:
    ...
    def update_predator_mode(
        ...
        *,
        ...
        """Open-field predator runtime used by the fly-catching simulation."""
        self.steps += 1
        self.juvenile_age += 1
        ...
        policy_confidence = clamp(policy_confidence + task_set_bias * 0.20, 0.0, 1.0)
        ...
        policy_conflict = clamp(policy_conflict - task_set_bias * 0.12, 0.0, 0.85)
        ...
        strike_readiness = clamp(
            (
                0.04
                + strongest_target_strength * 0.38
                + focus_closeness * 0.28
                + decision["goal_commitment"] * 0.20
                + action_vigor * 0.10
